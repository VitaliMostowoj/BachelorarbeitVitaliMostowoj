...
Das \textit{HealthMonitor} Verzeichnis ist das zentrale Element der Anwendung. In dieser werden die Klassen und Funktionen der Verzeichnisse \text{HM.TimerBasedScheduler} und \textit{HM.API} aufgerufen. Zudem enthält \textit{HealthMonitor} die \textit{Programm}, welche als Einstiegspunkt für die Anwendung dient.\\
